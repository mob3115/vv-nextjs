...
const ALL_VALUES = [
  'Community impact', 'Craftsmanship', 'Employee dignity', 'Long-term thinking',
  'Equity', 'Environmental justice', 'Editorial independence', 'Accessibility',
  'Clinical excellence', 'Worker safety', 'Creative excellence', 'Economic mobility',
  'Integrity', 'Compassionate care', 'Sustainability', 'Workforce development',
  'Client stewardship', 'Resident dignity', 'Authentic craft', 'Family values',
  'Quality over volume', 'Operational excellence', 'Reader trust', 'Diverse voices',
]
